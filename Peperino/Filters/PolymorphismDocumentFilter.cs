...
namespace Peperino.Filters
{
    public class PolymorphismDocumentFilter<T> : IDocumentFilter
    {
        ...
        private static void RegisterSubClasses(DocumentFilterContext context, Type abstractType)
        {
            ...
            {
                parentSchema.Properties.Add(discriminatorName, new OpenApiSchema { Type = "string", Default = new OpenApiString(abstractType.FullName), Nullable = true });
            }
